package com.testforwork.ejercicio1.core.navigation
...
import com.testforwork.ejercicio1.feature.userdetail.presentation.UserDetailScreen
import com.testforwork.ejercicio1.feature.userlist.presentation.UserListScreen
...
fun AppNavGraph(
    ...
    NavHost(
        ...
        composable(
            ...
            arguments = listOf(
                navArgument("lat") { type = NavType.Companion.FloatType },
                navArgument("long") { type = NavType.Companion.FloatType },
                navArgument("name") { type = NavType.Companion.StringType }
            )
        ) { backStackEntry ->
